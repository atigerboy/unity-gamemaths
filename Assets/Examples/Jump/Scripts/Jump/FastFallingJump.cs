...
public class FastFallingJump : MonoBehaviour
{
    ...
    {
        if( _posX > halfLenghth && accPoint == 0 )//change new acc
        {
            accPoint += 1;
            accArray[accPoint] = Accel(velX, ( 1.0f+coefficient )* halfLenghth - _posX, _pos);
        }
